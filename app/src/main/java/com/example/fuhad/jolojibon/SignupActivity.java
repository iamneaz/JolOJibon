...
public class SignupActivity extends AppCompatActivity {
    ...
    private static String URL = Config.USER_REGISTER;
    ...
    CheckBox check ;//(R.id.checkBoxCom);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        check = (CheckBox) findViewById(R.id.checkBoxCom);
