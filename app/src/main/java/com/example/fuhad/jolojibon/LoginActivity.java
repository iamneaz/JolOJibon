...
public class LoginActivity extends AppCompatActivity {
    ...
    private static String URL = Config.USER_LOGIN;
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if(go){
                                        ...
                                        editor.putString("Com",x.getString("com"));
                                        editor.commit();
                                        //Toast.makeText(getBaseContext(),"comm : "+x.getString("com")+"",Toast.LENGTH_LONG).show();
                                        onLoginSuccess();
                                    }else {
                                        onLoginFailed();
                                    }
    ...
    public void onLoginSuccess() {
        ...
        /*Toast.makeText(LoginActivity.this,dataSave.getBoolean("LoggedIn",false)+" "+
