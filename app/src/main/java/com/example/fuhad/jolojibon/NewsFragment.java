...
public class NewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        materialDesignFAM = (FloatingActionMenu) v.findViewById(R.id.newsfeedfab);
        floatingActionButton1 = (com.github.clans.fab.FloatingActionButton) v.findViewById(R.id.floating_prob);
        floatingActionButton2 = (com.github.clans.fab.FloatingActionButton) v.findViewById(R.id.floating_reload);
    ...
    private class webChecker extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if(Uri.parse(url).getHost().equals("www.kipailam.com/news_feed")){
                return false;
            }
